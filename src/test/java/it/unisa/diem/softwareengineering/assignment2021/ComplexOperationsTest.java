...
public class ComplexOperationsTest {
    ...
    @Test
    public void testArg(){
        ComplexNumber arg1=ComplexOperations.arg(new ComplexNumber(5.0,10.0));
        ComplexNumber arg2=ComplexOperations.arg(new ComplexNumber(-2.0,6.0));
        ComplexNumber arg3=ComplexOperations.arg(new ComplexNumber(10.0,-2.0));
        ComplexNumber arg4=ComplexOperations.arg(new ComplexNumber(14.5,0.0));
        ComplexNumber arg5=ComplexOperations.arg(new ComplexNumber(0.0, -4.5));

        ComplexNumber expected1=new ComplexNumber(1.107,0.0);
        ComplexNumber expected2=new ComplexNumber(1.893,0.0);
        ComplexNumber expected3=new ComplexNumber(-0.197,0.0);
        ComplexNumber expected4=new ComplexNumber(0.0,0.0);
        ComplexNumber expected5=new ComplexNumber(-1.571,0.0);

        assertEquals(expected1,round3(arg1));
        assertEquals(expected2,round3(arg2));
        assertEquals(expected3,round3(arg3));
        assertEquals(expected4,round3(arg4));
        assertEquals(expected5,round3(arg5));
    }

    @Test
    public void testMod(){
        ComplexNumber mod1=ComplexOperations.mod(new ComplexNumber(5.0,10.0));
        ComplexNumber mod2=ComplexOperations.mod(new ComplexNumber(-2.0,6.0));
        ComplexNumber mod3=ComplexOperations.mod(new ComplexNumber(10.0,-2.0));
        ComplexNumber mod4=ComplexOperations.mod(new ComplexNumber(14.5,0.0));
        ComplexNumber mod5=ComplexOperations.mod(new ComplexNumber(0.0, -4.5));

        ComplexNumber expected1=new ComplexNumber(11.180,0.0);
        ComplexNumber expected2=new ComplexNumber(6.325,0.0);
        ComplexNumber expected3=new ComplexNumber(10.198,0.0);
        ComplexNumber expected4=new ComplexNumber(14.5,0.0);
        ComplexNumber expected5=new ComplexNumber(4.5,0.0);

        assertEquals(expected1,round3(mod1));
        assertEquals(expected2,round3(mod2));
        assertEquals(expected3,round3(mod3));
        assertEquals(expected4,round3(mod4));
        assertEquals(expected5,round3(mod5));
    }
